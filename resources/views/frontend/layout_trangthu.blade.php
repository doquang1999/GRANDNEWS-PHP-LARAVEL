...
<body>
	...
	<!-- /endheader -->
		...
		$category = DB::table("categories")->where("id","=",$categories_id)->select("name")->first();
					...
					<div class="col-sm-12 col-xs-12">
						<div class="link-breadcrumb">
							<ol>
								...
								<li>
									<a class="bre-active">>> {{$category->name}}</a>
								</li>
							</ol>
						</div>
						<div class="title-danhmuc">
							<h1><span><i class="fa fa-newspaper-o"></i> <i class="fa fa-newspaper-o"></i> Tin tức <i class="fa fa-newspaper-o"></i> <i class="fa fa-newspaper-o"></i></span></h1>
						</div>
