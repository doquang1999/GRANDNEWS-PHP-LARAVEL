					...
					<div class="col-sm-12 col-xs-12">
						<div class="link-breadcrumb">
							<ol>
								...
								<li>
									<a class="bre-active">>> {{ Session::get('search')}}</a>
								</li>
							</ol>
						</div>
						<div class="title-danhmuc">
							<h1 class="title-search-reponsvie"><span><i class="fa fa-search"></i> Tìm kiếm tin tức <i class="fa fa-newspaper-o"></i> </span></h1>
							<p style="font-size:16px;">Tìm thấy có : <strong>{{ Session::get('soluong')}}</strong> kết quả</p>
						</div>
