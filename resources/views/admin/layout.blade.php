...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{url('admin/layout')}}" class="nav-link">Home</a>
      </li>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="{{url('admin/layout')}}" class="brand-link">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Xin chào : {{ Session::get('name')}}</a>
        </div>
      </div>
...
<li class="nav-header">Danh sách chức năng</li>
          ...
          <li class="nav-item">
           ...
           <li class="nav-item">
            ...
            <?php 
            $data = DB::table("contact")->where("active","=",0)->count();
             ?>
              <p>
                Contact List ( <strong style="color:red;">{{$data}}</strong> )
              </p>
            </a>
          </li>
